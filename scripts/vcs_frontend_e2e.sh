...
echo -e "${GREEN}    - Main Console & HTMX tabs: 100% Validated                          ${NC}"
...
echo -e "${GREEN}    - Headless Chrome Snapshot: docs/images/vcs_htmx_dashboard.png      ${NC}"
echo -e "${GREEN}    - Standalone HTML Report: test_reports/vcs_frontend_e2e_report.html ${NC}"
echo -e "${GREEN}========================================================================${NC}"
